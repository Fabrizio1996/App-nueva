<?php
	...
	$BACKUP_ORDER	= true;		
	$MERCHANT_TO	= "<70664972@continental.edu.pe>";		
	$MERCHANT_FROM	= "<70664972@continental.edu.pe>";	
	$MERCHANT_BCC 	= true;		
	$MERCHANT_DATE_FORMAT = "dd/mm/yyyy";	
	$CRLF 			= "\r\n";				
	$HTTP_PREFIX	= (false)?'https://':'http://';		
	$VO_CTR = "cdae145b088c4f2567ff0799530b96c9";					
	$MAX_PERIOD = -1;				
	$ORDER_EMAIL_ADD_URL = false;		
	$ACCOUNTS_URL = "";
	$COOKIE_ACCOUNT_INF = "55aa-account_inf";
